...
export default function InternalLinks({ currentToolId, title = "Related Tools" }: InternalLinksProps) {
  ...
  return (
    <nav className="internal-links" role="navigation" aria-label="Page navigation">
      ...
      <div className="flex flex-wrap gap-4 text-sm pt-4 border-t border-slate-200 dark:border-slate-700">
        <Link
          to="/all-tools"
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 text-indigo-700 dark:text-indigo-400 rounded-lg transition-colors"
          aria-label="Go to homepage"
        >
          <Home size={14} />
          Homepage
