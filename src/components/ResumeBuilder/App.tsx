...
export default function ResumeBuilderApp() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#F8FAFC] text-slate-800 font-sans overflow-hidden" style={{ colorScheme: 'light' }}>
      ...
      <div className="md:hidden h-16 px-4 bg-white border-b border-slate-200 flex items-center justify-between flex-shrink-0 z-50 relative">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button 
            ...
            className="px-3 py-2 text-sm font-medium bg-indigo-600 text-white rounded-md shadow-sm hover:bg-indigo-700 transition-all disabled:opacity-50 whitespace-nowrap flex-shrink-0"
          >
            {isExporting ? '...' : 'PDF'}
          </button>
        </div>
      ...
      <main className="flex-1 flex overflow-hidden lg:flex-row flex-col min-h-0">
        ...
        <div className="flex-1 flex lg:flex-row flex-col overflow-hidden order-1 lg:order-2 min-h-0">
          ...
          {/* Preview Panel */}
          <div className={cn(
            "flex-1 bg-slate-50/50 border-l border-slate-200/50 min-h-0",
